...
type GranskasModus = 'akt' | 'sfo' | 'sfo *'
...
function splitVerbTag(tag: GranskasVerbTag): ['vb', GranskasTempus, GranskasModus?] {
  return tag.split('.') as ['vb', GranskasTempus, GranskasModus?]
}
